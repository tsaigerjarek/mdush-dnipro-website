...
export const weeklyItems: WeeklyItem[] = [
  ...
  },
  {
    ...
    status: 'info',
    featured: false,
    title: 'Команда U17 (2010 р.н.): Навчально-тренувальний план',
  ...
  },
  {
    ...
    status: 'info',
    featured: false,
    title: 'Дівочий футбол (WFU-15 та WFU-12): Тренувальний процес',
    summary: 'Підготовка дівочих команд закладу (WFU-15 2012 р.н. та WFU-12 2014 р.н.) до участі у профільних змаганнях.',
    image: '/media/hero/hero-mdush-fallback.jpg',
    imageAlt: 'Дівочий футбол МДЮСШ Дніпро',
    detailsUrl: '/sportyvni-napriamy/#football',
